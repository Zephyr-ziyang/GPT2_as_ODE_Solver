...
eval_schema = {
    ...
    "evaltype": merge(tstring,allowed(EVAL_TYPE), default("common_output")),
    ...
    "batch_size": merge(tinteger, default(64)),
    "draw_diff": merge(tboolean, nullable, default(False)),
    "draw_steperr": merge(tboolean, nullable, default(False)),
    "draw_relativeh_steperr": merge(tboolean, nullable, default(False)),
    "err_vector_norm": merge(tboolean, nullable, default(False)),
}
wandb_schema = {
